...
namespace UltraSim.ECS.Events
{
    ...
    /// <summary>
    /// Event args for entity batch destruction events.
    /// Provides access to entities that were just destroyed.
    /// Uses same structure as EntityBatchCreatedEventArgs for consistency.
    /// </summary>
    public readonly struct EntityBatchDestroyedEventArgs
    {
        ...
        /// <summary>
        /// Get a ReadOnlySpan view of the destroyed entities.
        /// ZERO ALLOCATION - Uses CollectionsMarshal.AsSpan when source is List.
        /// </summary>
        public ReadOnlySpan<Entity> GetSpan()
        {
    ...
    /// <summary>
    /// Delegate for entity batch destroyed events.
    /// </summary>
